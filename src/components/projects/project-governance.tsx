                    ...
                    <Card className="relative overflow-hidden bg-card dark:from-slate-900 dark:via-black dark:to-slate-900 border-muted">
                        <CardHeader className="pb-4">
                            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
                                ...
                                <Badge
                                    variant="secondary"
                                    className={`px-3 py-1 text-xs font-semibold capitalize ${source === 'custom'
                            ...
                            <div className="space-y-6">
                                ...
                                <Alert className="bg-indigo-50/50 border-indigo-200 dark:bg-indigo-950/10 dark:border-indigo-900">
                                    ...
                                    <AlertDescription className="text-indigo-700 dark:text-indigo-300 text-xs space-y-1">
                                        <p>Square Sandbox payments are enabled. Back this project to dynamically allocate credit weightings. Manual tracks are preserved for offline/lead transactions.</p>
                                        <p className="font-semibold mt-1">Status: Sandbox card processing active via Square Checkout</p>
                                    </AlertDescription>
                                </Alert>
                                                            ...
                                                            <div className="p-4 space-y-3">
                                                                ...
                                                                <div className="space-y-1 pt-1.5">
                                                                    ...
                                                                    <div className="relative w-full h-3 bg-muted rounded-full overflow-visible">
                                                                        <div
                                                                            className={`h-full rounded-full transition-all duration-300 ${goal.isFunded
                                                                                    ? 'bg-emerald-500'
