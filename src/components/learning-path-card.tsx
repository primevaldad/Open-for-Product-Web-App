...
export default function LearningPathCard({ path }: LearningPathCardProps) {
    ...
    return (
        <Link href={buildHybridUrl('/learning', path.pathId, path.title)} className="block p-6 bg-card rounded-lg border border-gray-200 shadow-md hover:bg-muted dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
