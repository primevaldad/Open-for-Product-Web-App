...
export const rawUsers: Omit<User, 'onboarded'>[] = [
  {
    ...
    interests: ['UI/UX Design', 'Frontend Development', 'Community'],
  },
  {
    id: 'u2',
    name: 'Bethany Smith',
    ...
    interests: ['Product Management', 'Community', 'Business & Enterprise'],
  },
  {
    id: 'u3',
    name: 'Charlie Brown',
    ...
    interests: ['Data Science', 'Learning & Research', 'Technical'],
  },
  {
    id: 'u4',
    name: 'Diana Prince',
    ...
    interests: ['UI/UX Design', 'Creative', 'Frontend Development'],
    onboarded: false,
  },
];
...
export const rawProjects = [
    {
      ...
      category: 'Community',
      timeline: '3-6 Months',
      contributionNeeds: ['UI/UX Design', 'React', 'Firebase', 'Community Management'],
      progress: 75,
      team: [
        { user: 'u1', role: 'lead' },
        { user: 'u2', role: 'participant' },
      ],
      votes: 128,
      discussions: 42,
      status: 'published',
    ...
    },
    {
      ...
      contributionNeeds: ['Next.js', 'Instructional Design', 'GraphQL', 'Marketing'],
      progress: 45,
      team: [
        { user: 'u3', role: 'lead' },
        { user: 'u1', role: 'participant' },
      ],
      votes: 256,
      discussions: 89,
      status: 'published',
    ...
    },
    {
      ...
      category: 'Technical',
      timeline: '9 Months',
      contributionNeeds: ['Python', 'Machine Learning', 'Ethics in AI', 'Technical Writing'],
      progress: 20,
      team: [
        { user: 'u2', role: 'lead' },
      ],
    ...
    },
     {
      ...
      category: 'Creative',
      timeline: 'TBD',
      contributionNeeds: ['Generative AI', 'UI/UX Design', 'Frontend Development'],
      progress: 0,
      team: [
        { user: 'u4', role: 'lead' },
      ],
...
export const rawInterests: Interest[] = [
    ...
    { id: 'i4', name: 'Community' },
    { id: 'i5', name: 'Product Management' },
    { id: 'i6', name: 'Data Science' },
    { id: 'i7', name: 'Learning & Research' },
    { id: 'i8', name: 'Business & Enterprise' },
    { id: 'i9', name: 'Creative' },
    { id: 'i10', name: 'Technical' },
];
